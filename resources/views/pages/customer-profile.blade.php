                                            ...
                                            <div class="d-flex flex-column align-items-center text-center">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="col-sm-9  m-auto text-secondary">
                                                        <input type="button" class="btn btn-sm btn-primary px-4"
                                                               value="Update Photo"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input type="text" class="form-control"
                                                           value="Bay Area, San Francisco, CA" disabled/>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input type="button" data-bs-toggle="modal"
                                                           data-bs-target="#exampleModal" class="btn btn-primary px-4"
                                                           value="Update"/>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center mb-4 gap-3">
                                <div class="position-relative">
                                    <h1 class=" fw-bold fs-4">Purchase History</h1>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>#25,000</td>
                                        <td>Adewale</td>
                                        <td><a href="javascript:;" type="button"
